...
public class ConstantUtil {
    public static final String USER_REF = "GHotelBookMan/Users";
    public static final String HOTEL_REF = "GHotelBookMan/Hotels";
    public static final String RESERVATION_REF = "GHotelBookMan/Reservations";
